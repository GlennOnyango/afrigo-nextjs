            ...
            <form className="bg-white rounded p-6 sm:p-8 space-y-6">
              ...
              <div>
                ...
                >
                  ...
                  <option>
                    {t(
                      "service.customize-section.form.industry.options.manufacturing",
                    )}
                  </option>
                  <option>
                    {t(
                      "service.customize-section.form.industry.options.retail",
                    )}
                  </option>
                  <option>
                    {t(
                      "service.customize-section.form.industry.options.technology",
                    )}
                  </option>
                  <option>
                    {t(
                      "service.customize-section.form.industry.options.logistics",
                    )}
                  </option>
                  <option>
                    {t(
                      "service.customize-section.form.industry.options.construction",
                    )}
                  </option>
                  <option>
                    {t(
                      "service.customize-section.form.industry.options.agriculture",
                    )}
                  </option>
                  <option>
              ...
              <div>
                ...
                <select className="w-full border-2 border-gray-300 rounded px-4 py-3 focus:outline-none focus:border-blue-900 bg-white">
                  ...
                  <option>
                    {t(
                      "service.customize-section.form.budget.options.under-10k",
                    )}
                  </option>
                  <option>
                  ...
                  <option>
                    {t(
                      "service.customize-section.form.budget.options.50k-100k",
                    )}
                  </option>
                  <option>
                    {t(
                      "service.customize-section.form.budget.options.100k-250k",
                    )}
                  </option>
                  <option>
                    {t(
                      "service.customize-section.form.budget.options.250k-plus",
                    )}
                  </option>
                </select>
              </div>
              ...
              <div>
                ...
                >
                  ...
                  <option>
                    {t(
                      "service.customize-section.form.timeline.options.immediately",
                    )}
                  </option>
                  <option>
                    {t(
                      "service.customize-section.form.timeline.options.within-1-month",
                    )}
                  </option>
                  <option>
                    {t(
                      "service.customize-section.form.timeline.options.1-3-months",
                    )}
                  </option>
                  <option>
                    {t(
                      "service.customize-section.form.timeline.options.3-6-months",
                    )}
                  </option>
                  <option>
                    {t(
                      "service.customize-section.form.timeline.options.just-exploring",
                    )}
                  </option>
                </select>
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder={t(
                    "service.customize-section.form.details.placeholder",
                  )}
                />
              </div>
              ...
              >
                {t("service.customize-section.form.submit")}
              </button>
